 ...
 * as defined by the unicode standard (iso-8859-1).
 ...
 * characters 32-127. These are all graphics characters defined in ASCII.
 */
devcon_charset devcon_unicode_lower = {
	[0] = 32,
	[1] = 33,
	[2] = 34,
	[3] = 35,
...
/*
 * Upper Unicode Table
 * This maps all characters to the upper unicode characters 160-255. These are
 * not compatible to any older 8 bit character sets. See the Unicode standard
 * for the definitions of each symbol.
 */
devcon_charset devcon_unicode_upper = {
	[0] = 160,
	[1] = 161,
	[2] = 162,
	[3] = 163,
 ...
 * mix them up!
 */
devcon_charset devcon_dec_supplemental_graphics = {
	[0] = -1,       /* undefined */
	[1] = 161,
	[2] = 162,
	[3] = 163,
 ...
 */
devcon_charset devcon_dec_special_graphics = {
	[0] = -1,       /* undefined */
	[1] = 33,
	[2] = 34,
	[3] = 35,
